...
const loadData=async ()=>{
    let response=await fetch(`${process.env.REACT_APP_SERVER_DOMIN}/api/foodData`,{
        method:"POST",
        headers:{
...
useEffect(()=>{
    ...
    return (
        <div>
            <div><Navbar /></div>
            <div> <div id="carouselExampleInterval" className="carousel slide" data-bs-ride="carousel" style={{objextFit:"contain !important"}}>
